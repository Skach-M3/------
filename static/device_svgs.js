...
export const MAP_SVGS = {
    ...
    cable_turning_point:
        ...
        + '<path fill="#fff" d="M235.7,97.3C242.6,109.2,249.2,120.7,255.8,132.3C264.2,146.9,272.6,161.6,281,'
        + '176.2C291.3,193.9,301.6,211.6,311.8,229.3C320.2,243.9,328.6,258.6,337,273.2C347.3,290.9,357.6,308.6,'
        + '367.8,326.3C373.2,335.6,378.5,344.8,384.1,354.5C261.7,354.5,139.6,354.5,16.9,354.5C78,248.7,139,143,200.5,36.5C212.3,57,223.9,77,235.7,97.3Z"/>'
        + '</svg>',
